...
CREATE TABLE tbl_games (
	...
	game_as_image varchar(255) NULL,
...
CREATE TABLE tbl_game_boards (
	...
	CONSTRAINT fk_tbl_game_boards_tbl_games FOREIGN KEY (game_id) REFERENCES tbl_games(id)
);


-- tbl_players definitions
...
CREATE TABLE tbl_players (
	...
	CONSTRAINT fk_tbl_players_tbl_game_boards FOREIGN KEY (game_board_id) REFERENCES tbl_game_boards(id)
);
...
CREATE TABLE tbl_questions (
	...
	CONSTRAINT fk_tbl_questions_tbl_games FOREIGN KEY (game_id) REFERENCES tbl_games(id)	
);
...
CREATE TABLE tbl_answers (
	...
	CONSTRAINT fk_tbl_answers_tbl_answer_groups FOREIGN KEY (answer_group_id) REFERENCES tbl_answer_groups(id),
	CONSTRAINT fk_tbl_answers_tbl_games FOREIGN KEY (game_id) REFERENCES tbl_games(id),
...
CREATE TABLE tbl_answered_questions (
	...
	CONSTRAINT fk_tbl_answered_questions_tbl_game_boards FOREIGN KEY (game_board_id) REFERENCES tbl_game_boards(id)
);
...
CREATE TABLE tbl_answered_question_details (
	id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY,	
	answered_question_id BIGINT NULL,
	player_id BIGINT NULL,
	answer_content varchar(255) NULL,
	answer_content_as_image varchar(255) NULL,	
	CONSTRAINT tbl_answered_question_details_pkey PRIMARY KEY (id),
	CONSTRAINT fk_tbl_answered_question_details_tbl_answered_questions FOREIGN KEY (answered_question_id) REFERENCES tbl_answered_questions(id),
	CONSTRAINT fk_tbl_answered_question_details_tbl_players FOREIGN KEY (player_id) REFERENCES tbl_players(id)
);